    ...
    <div>
      <form onSubmit={updateUserHandler}>
        ...
        <div className="mb-5">
          <textarea
            type="text"
            value={formData.mycase}
            onChange={handleInputChange}
            name="mycase"
            placeholder="Add summary of your bug in short"
            className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-[#25b7e3] text-[16px] leading-7 text-headingColor placeholder:text-textColor"></textarea>
