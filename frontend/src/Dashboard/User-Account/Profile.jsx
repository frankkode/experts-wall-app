      ...
      <form onSubmit={updateUserHandler}>
        ...
        <div className="mb-5">
          <textarea
            ...
            className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-[#0067FF] text-[16px] leading-7 text-headingColor placeholder:text-textColor"></textarea>
