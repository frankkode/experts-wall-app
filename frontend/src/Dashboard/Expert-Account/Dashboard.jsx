...
// import expertImg from "../../assets/images/expert-img02.png";
...
const Dashboard = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useGetProfile(`${BASE_URL}/experts/profile/me`);
          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px] ">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                  ...
                  <div>
                    <div className="flex gap-5 items-center mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img src={expertData.photo} alt="" className="w-full" />
                      </figure>
                      <div>
                ...
                {tab === "settings" && <Profile expertData={expertData} />}
                {tab === "appointments" && (
                  <Appointments appointments={expertData.appointments} />
                )}
              </div>
            </div>
          </div>
