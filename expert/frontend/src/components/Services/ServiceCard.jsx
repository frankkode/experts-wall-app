...
const ServiceCard = ({item,index}) => {
  ...
  return (
    <div className="py-[30px] px-3 lg:px-5">
     <span className='w-[44px] h-[44px] flex items-center justify-center text-[18px] leading-[30px] font-[600]' style= {{background:`${bgColor}`, color:`${textColor}`, borderRadius:"100%px",}}>{index + 1}</span> 
